...
export const columns: ColumnDef<Student>[] = [
  ...
  },
  {
    ...
    size: 80,
    cell: ({ row, table }) => <PaymentStatusCell student={row.original} isRegistration={true} month={-1} year={(table.options.meta as any)?.selectedYear} />,
  },
  {
    accessorKey: 'book_fee_sort',
    header: ({ column }) => <SortableHeader column={column} title="Book" />,
    size: 80,
    cell: ({ row, table }) => <PaymentStatusCell student={row.original} isBookFee={true} month={-2} year={(table.options.meta as any)?.selectedYear} />,
  },
  {
    accessorKey: 'januari_sort',
    header: ({ column }) => <SortableHeader column={column} title="Jan" />,
    size: 80,
    cell: ({ row, table }) => <PaymentStatusCell student={row.original} month={0} year={(table.options.meta as any)?.selectedYear} />,
  },
  {
    accessorKey: 'februari_sort',
    header: ({ column }) => <SortableHeader column={column} title="Feb" />,
    size: 80,
    cell: ({ row, table }) => <PaymentStatusCell student={row.original} month={1} year={(table.options.meta as any)?.selectedYear} />,
  },
  {
    accessorKey: 'maret_sort',
    header: ({ column }) => <SortableHeader column={column} title="Mar" />,
    size: 80,
    cell: ({ row, table }) => <PaymentStatusCell student={row.original} month={2} year={(table.options.meta as any)?.selectedYear} />,
  },
  {
    accessorKey: 'april_sort',
    header: ({ column }) => <SortableHeader column={column} title="Apr" />,
    size: 80,
    cell: ({ row, table }) => <PaymentStatusCell student={row.original} month={3} year={(table.options.meta as any)?.selectedYear} />,
  },
  {
    accessorKey: 'mei_sort',
    header: ({ column }) => <SortableHeader column={column} title="Mei" />,
    size: 80,
    cell: ({ row, table }) => <PaymentStatusCell student={row.original} month={4} year={(table.options.meta as any)?.selectedYear} />,
  },
  {
    accessorKey: 'juni_sort',
    header: ({ column }) => <SortableHeader column={column} title="Jun" />,
    size: 80,
    cell: ({ row, table }) => <PaymentStatusCell student={row.original} month={5} year={(table.options.meta as any)?.selectedYear} />,
  },
  {
    accessorKey: 'juli_sort',
    header: ({ column }) => <SortableHeader column={column} title="Jul" />,
    size: 80,
    cell: ({ row, table }) => <PaymentStatusCell student={row.original} month={6} year={(table.options.meta as any)?.selectedYear} />,
  },
  {
    accessorKey: 'agustus_sort',
    header: ({ column }) => <SortableHeader column={column} title="Ags" />,
    size: 80,
    cell: ({ row, table }) => <PaymentStatusCell student={row.original} month={7} year={(table.options.meta as any)?.selectedYear} />,
  },
  {
    accessorKey: 'september_sort',
    header: ({ column }) => <SortableHeader column={column} title="Sep" />,
    size: 80,
    cell: ({ row, table }) => <PaymentStatusCell student={row.original} month={8} year={(table.options.meta as any)?.selectedYear} />,
  },
  {
    accessorKey: 'oktober_sort',
    header: ({ column }) => <SortableHeader column={column} title="Okt" />,
    size: 80,
    cell: ({ row, table }) => <PaymentStatusCell student={row.original} month={9} year={(table.options.meta as any)?.selectedYear} />,
  },
  {
    accessorKey: 'november_sort',
    header: ({ column }) => <SortableHeader column={column} title="Nov" />,
    size: 80,
    cell: ({ row, table }) => <PaymentStatusCell student={row.original} month={10} year={(table.options.meta as any)?.selectedYear} />,
  },
  {
    accessorKey: 'desember_sort',
    header: ({ column }) => <SortableHeader column={column} title="Des" />,
    size: 80,
    cell: ({ row, table }) => <PaymentStatusCell student={row.original} month={11} year={(table.options.meta as any)?.selectedYear} />,
  },
